...
void credit(){
    ...
    cout<<"Computer Graphics- Final Project"<<endl;
     cout<<"\t 1. Sami, Sadman Kabir [18-37378-1]"<<endl;
    cout<<"\t 2. Shifat, Shadril Hassan [20-42451-1]"<<endl;
    cout<<"\t 3. Kamran, Md. Saifulla [18-36713-1]"<<endl;
    cout<<"\t 4. Ummee, Zinat Refaiat [20-42487-1]"<<endl;
    cout<<"\t 5. Mamun,Mohammad Reefat Al [17-34754-2]"<<endl;
    cout<<"------------------------------------------------------"<<endl;
